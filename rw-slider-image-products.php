...
?>
<div class="rw-products-main-div">
	<div class="rw-product-div">
		...
		<a href="<?php echo esc_url('http://rich-web.org/wp-contact-form/'); ?>" target="_blank"> View More </a>
	</div>
	<div class="rw-product-div">
		...
		<a href="<?php echo esc_url('http://rich-web.org/wp-image-gallery/'); ?>" target="_blank"> View More </a>
	</div>
	<div class="rw-product-div">
		...
		<a href="<?php echo esc_url('http://rich-web.org/wp-image-slider/'); ?>" target="_blank"> View More </a>
	</div>
	<div class="rw-product-div">
		...
		<a href="<?php echo esc_url('http://rich-web.org/wp-video-slider/'); ?>" target="_blank"> View More </a>
	</div>
	<div class="rw-product-div">
		...
		<a href="<?php echo esc_url('http://rich-web.org/wp-tab-accordion/'); ?>" target="_blank"> View More </a>
	</div>
	<div class="rw-product-div">
		...
		<a href="<?php echo esc_url('http://rich-web.org/wp-coming-soon/'); ?>" target="_blank"> View More </a>
	</div>
	<div class="rw-product-div">
		...
		<a href="<?php echo esc_url('http://rich-web.org/wp-share-button/'); ?>" target="_blank"> View More </a>
	</div>
	<div class="rw-product-div">
		...
		<a href="<?php echo esc_url('http://rich-web.org/wp-event-timeline/'); ?>" target="_blank"> View More </a>
	</div>
</div>