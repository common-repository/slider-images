...
Tags: slider, wordpress slider, image slider, photo slider, slider plugin, responsive slider, post slider, video slider, images slider,
...
* Solved the problem with the slider. You can put several slides on one page.
...
* Fixed problem SQL queries.
* Fixed problem for Add Video Media button
...
* Added a function to create a theme.
* Changed the design on the admin panel.

= 1.4.5 =

* Fixed problem with slideshow.
...
* Solved the problem with the link to another page.

= 1.4.2 =

* In The Navigation version adds the ability to link. You can click on the image to go to another page.
